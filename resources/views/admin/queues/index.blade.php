...
<div class="bg-white rounded-lg shadow" x-data="{}">
    <div class="p-6 border-b border-gray-200">
        ...
        <!-- Section Récapitulatif - Uniquement visible par les administrateurs -->
        @if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('super-admin'))
        <div class="mb-8">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Tableau de bord</h3>
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <!-- Carte Nombre total de files -->
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-sm font-medium text-gray-900 truncate">
                                        @if($stats['latest_queue'])
                                            {{ $stats['latest_queue']->name }}
                                            <span class="text-xs text-gray-500">
                                                ({{ $stats['latest_queue']->created_at->diffForHumans() }})
                                            </span>
                                        @else
                                            Aucune file
                                        @endif
