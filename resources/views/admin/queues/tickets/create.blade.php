        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Nouveau Ticket - {{ $queue->name }}</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.queues.tickets.store', $queue) }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="wants_notifications"
                                    name="wants_notifications" value="1" {{ old('wants_notifications') ? 'checked' : '' }}>
                        ...
                        <div class="form-group notification-channel" style="display: none;">
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="notification_email"
                                    name="notification_channel" value="email" {{ old('notification_channel') === 'email' ? 'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" id="notification_sms"
                                    name="notification_channel" value="sms" {{ old('notification_channel') === 'sms' ? 'checked' : '' }}>
