    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.services.update', $service->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="color" name="color" id="color" value="{{ old('color', $service->color) }}" 
                               class="h-10 w-16 p-1 border border-gray-300 rounded-r-md">
                        <input type="text" value="{{ old('color', $service->color) }}" 
            ...
            <div class="flex justify-between items-center">
                <button type="button" 
                        onclick="if(confirm('Êtes-vous sûr de vouloir supprimer ce service ?')) { document.getElementById('delete-form').submit(); }" 
